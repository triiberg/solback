...
func (s *ZipService) Download(ctx context.Context, link string, sourceURL string) (ZipResult, error) {
	if s == nil {
	...
	if err != nil {
		...
		_ = s.logService.CreateLog(ctx, LogActionZipDownload, LogOutcomeFail, &failMsg)
	...
	_ = s.logService.CreateLog(ctx, LogActionZipDownload, LogOutcomeSuccess, &successMsg)
